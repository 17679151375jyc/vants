<template>
    <div>        
        <van-button type='info' @click="$router.back(-1)">返回</van-button>
      ...
      <div class="show-info">
        ...
        <div class="test">
          <vueCropper ref="cropper2" 
            ...
            :autoCropWidth="example2.autoCropWidth" :autoCropHeight="example2.autoCropHeight" 
